...
const contenedorNumerito = document.querySelector("#numerito-compra");
...
function actualizarNumerito(){
    let numerito = carrito.reduce((acc, producto) => acc + producto.cantidad, 0);
    contenedorNumerito.classList.remove("emptyclass");
    contenedorNumerito.innerHTML = numerito;
    if (carrito.length === 0){
        contenedorNumerito.classList.add("emptyclass");
    }
}
